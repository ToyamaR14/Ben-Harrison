...
<body>
    <div class="container">
        ...
        <main>
            <h1 class="text-muted">Mess<span class="warning">ages</span></h1>
            ...
            <div class="date">
                ...
                <div class="modal-con" id="messageModal">
                    ...
                    <div class="modal-content-con" value="<?php echo isset($row['message_id'])? $row['message_id']: ''; ?>">
                ...
                <div class="panel">
                    <form action="proc.php" method="POST"> 
                        ...
                        <textarea class="text" type="text1" autocomplete="off" name="description" placeholder="Body..." required rows="5"></textarea>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result_messages)) { ?>
                                        <tr>    
                                            ...
                                            <td class='message-btn'>
                                                <button type='button' class='read' id='<?php echo $row['message_id']; ?>' 
                                                    onclick="openMessageModal(<?php echo $row['message_id']; ?>)">
