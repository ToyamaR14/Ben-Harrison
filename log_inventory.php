...
<main>     
    <div class="log-table anim t1">
        <div class="logbtn">
            <a href="logs.php#Inventory" class="buttonlogr">Return to Brief Inventory Log</a>
        </div>
    ...
    if (!empty($filtervalues)) {
        $query .= " WHERE CONCAT(log_tbl_i.item_id, log_tbl_i.inventory_log_id, log_tbl_i.date_entry, log.log_type) LIKE '%$filtervalues%' ";
    }
    
    $query .= " ORDER BY log_tbl_i.inventory_log_id DESC
    ...
    $count_query = "SELECT COUNT(*) AS total 
                    ...
                    ON log_tbl_i.log_type_id = log.log_type_id";
    if (!empty($filtervalues)) {
        $count_query .= " WHERE CONCAT(log_tbl_i.item_id, log_tbl_i.inventory_log_id, log_tbl_i.date_entry, log.log_type) LIKE '%$filtervalues%'";
    }
