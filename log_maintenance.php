...
<main>     
    <div class="log-table anim t1">
        <div class="logbtn">
            <a href="logs.php#Maintenance" class="buttonlogr">Return to Brief Maintenance Log</a>
        </div>
    ...
    if (!empty($filtervalues)) {
        $query .= " WHERE CONCAT(log_tbl_m.request_id, log_tbl_m.log_maint_id, log_tbl_m.date_entry, log.log_type) LIKE '%$filtervalues%' ";
    }

    $query .= " ORDER BY log_tbl_m.log_maint_id DESC
    ...
    $count_query = "SELECT COUNT(*) AS total 
                    ...
                    ON log_tbl_m.log_type_id = log.log_type_id";
    if (!empty($filtervalues)) {
        $count_query .= " WHERE CONCAT(log_tbl_m.request_id, log_tbl_m.log_maint_id, log_tbl_m.date_entry, log.log_type) LIKE '%$filtervalues%'";
    }
