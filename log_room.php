...
<main>     
    <div class="log-table anim t1">
        <div class="logbtn">
            <a href="logs.php#Room" class="buttonlogr">Return to Brief Room Log</a>
        </div>
    ...
    if (!empty($filtervalues)) {
        $query .= " WHERE CONCAT(log_tbl_r.room_id, log_tbl_r.room_log_id, log_tbl_r.date_entry, log.log_type) LIKE '%$filtervalues%' ";
    }
    
    $query .= " ORDER BY log_tbl_r.room_log_id DESC
    ...
    $count_query = "SELECT COUNT(*) AS total 
                    ...
                    ON log_tbl_r.log_type_id = log.log_type_id";
    if (!empty($filtervalues)) {
        $count_query .= " WHERE CONCAT(log_tbl_r.room_id, log_tbl_r.room_log_id, log_tbl_r.date_entry, log.log_type) LIKE '%$filtervalues%'";
    }
